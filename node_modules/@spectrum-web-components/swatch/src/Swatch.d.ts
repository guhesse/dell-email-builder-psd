...
export declare type SwatchBorder = 'light' | 'none' | undefined;
export declare type SwatchRounding = 'none' | 'full' | undefined;
export declare type SwatchShape = 'rectangle' | undefined;
