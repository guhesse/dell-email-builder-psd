 ...
 * @private
 */
_FieldLabel.instanceCount = 0;
__decorateClass([
  property({ type: Boolean, reflect: true })
], _FieldLabel.prototype, "disabled", 2);
__decorateClass([
  property({ type: String })
], _FieldLabel.prototype, "id", 2);
__decorateClass([
  property({ type: String })
], _FieldLabel.prototype, "for", 2);
__decorateClass([
  property({ type: Boolean, reflect: true })
], _FieldLabel.prototype, "required", 2);
__decorateClass([
  query("slot")
], _FieldLabel.prototype, "slotEl", 2);
__decorateClass([
  property({ type: String, reflect: true, attribute: "side-aligned" })
], _FieldLabel.prototype, "sideAligned", 2);
