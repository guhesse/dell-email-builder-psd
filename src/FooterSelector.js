                    ...
                    <div>
                        <sp-picker id="picker-m" size="m" label="Selection type" placeholder="Selecione o footer">
                            <sp-menu >
                                ...
                                <sp-menu-divider></sp-menu-divider>
                                <sp-menu-item selected={selectedFooter === 'aw-three-btn'} onClick={() => handleFooterClick('aw-three-btn')}>Alienware 3 Button</sp-menu-item>
                                <sp-menu-item selected={selectedFooter === 'csb-four-btn'} onClick={() => handleFooterClick('aw-four-btn')}>Alienware 4 Button</sp-menu-item>
                                <sp-menu-item selected={selectedFooter === 'gaming'} onClick={() => handleFooterClick('gaming')}>Gaming</sp-menu-item>
                                <sp-menu-divider></sp-menu-divider>
