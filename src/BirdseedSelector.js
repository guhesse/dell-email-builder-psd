...
export default function BirdseedSelector() {
    ...
    const handleBlur = (key) => {
        ...
        setBirdseedCopyValues(tempFormState[key]);
    ...
    const [isChecked, setChecked] = useState(selectedBirdseedCopy);

    const handleCheckboxChange = () => {
        handleBirdseedCopyClick();
    };
                                ...
                                <sp-picker placeholder="Selecione o birdseed" style={{ padding: '0', margin: "0" }} id="picker-m" size="m" label="Selection type">
                                    <sp-menu>
                                        <sp-menu-group>
                                            ...
                                            <sp-menu-item selected={selectedBirdseed === "standard" ? selected.selectedBirdseed : undefined} onClick={() => handleBirdseedClick("standard")}>Standard</sp-menu-item>
                                            <sp-menu-item selected={selectedBirdseed === "outlet" ? selected.selectedBirdseed : undefined} onClick={() => handleBirdseedClick("outlet")}>Outlet</sp-menu-item>
                                        </sp-menu-group>
                                    </sp-menu>
                                </sp-picker>
                            </div>
