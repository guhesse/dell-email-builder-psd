...
export default function SkinnySelector() {
    ...
    const [selected, setSelected] = useState({
        selectedSkinny: false
    });

    const handleResetClick = () => {
        setSelectedSkinny(null)
        setSkinnyTitleValue("")
        setSkinnyCopyValue("")
    };
            ...
            <div style={{ display: "flex", flexWrap: "wrap", alignItems: "flex-start", flexDirection: "column" }} className="group">
                <sp-icons>
                    <div style={{ display: "flex", alignItems: "center" }}>
                        {((selectedSkinny !== null && skinnyTitleValue !== "" && skinnyCopyValue !== "") || selectedSkinny === "") ? (
                            ...
                            ((selectedSkinny !== null && skinnyTitleValue === "" && skinnyCopyValue === "")) ? (
                        ...
                        <sp-field-group style={{ width: "100vw", display: "flex", flexDirection: "row", gap: "5px" }}>
                            <sp-picker style={{ margin: "0 4px 0 0" }} id="picker-m" size="m" label="Selection type" placeholder="Selecione o skinny banner">
                                <sp-menu>
                                    ...
                                    <sp-menu-item selected={selectedSkinny === "left" ? selected.selectedSkinny : undefined} onClick={() => handleSkinnyClick('left')}>Left</sp-menu-item>
                ...
                {selectedSkinny && isEditClicked && isOptionsOpen && (
                    <>
                        <>
