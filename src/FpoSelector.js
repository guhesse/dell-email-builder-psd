...
export default function FpoSelector() {
    ...
    const [selected, setSelected] = useState({
        selectedFpoValue: false,
        selectedFpoSegment: false
    });
            ...
            <div style={{ display: "flex", flexWrap: "wrap", alignItems: "flex-start" }} className="group">
                <sp-icons>
                    <div style={{ display: "flex", alignItems: "center" }}>
                        {(selectedFpoValue !== null && selectedFpoSegment !== null) ? (
                            ...
                            <sp-field-group style={{ display: "flex", flexDirection: "row" }}>
                                <sp-picker class='largePicker' placeholder="Selecione quantos FPO's" style={{ padding: "0" }} id="picker-m" size="m" label="Selection type">
                                    <sp-menu>
                                        ...
                                        <sp-menu-item selected={selectedFpoValue === 2 ? selected.selectedFpoValue : undefined}  onClick={() => handleFpoValueClick(2)}>2</sp-menu-item>
                                        <sp-menu-item selected={selectedFpoValue === 3 ? selected.selectedFpoValue : undefined}  onClick={() => handleFpoValueClick(3)}>3</sp-menu-item>
                                        <sp-menu-item selected={selectedFpoValue === 4 ? selected.selectedFpoValue : undefined}  onClick={() => handleFpoValueClick(4)}>4</sp-menu-item>
                                        <sp-menu-item selected={selectedFpoValue === 5 ? selected.selectedFpoValue : undefined}  disabled onClick={() => handleFpoValueClick(5)}>5</sp-menu-item>
                                    </sp-menu>
                                </sp-picker>
                            </sp-field-group>
                        </div>
                        ...
                        <sp-field-group>
                            <sp-picker class='largePicker' placeholder="Seguimento do FPO" style={{ padding: "0" }} id="picker-m" size="m" label="Selection type">
                                <sp-menu>
                                    ...
                                    <sp-menu-item selected={selectedFpoSegment === "gaming" ? selected.selectedFpoSegment : undefined} disabled onClick={() => handleFpoSegmentClick('gaming')}>Gaming</sp-menu-item>
                                    <sp-menu-item selected={selectedFpoSegment === "alienware" ? selected.selectedFpoSegment : undefined} disabled onClick={() => handleFpoSegmentClick('alienware')}>Alienware</sp-menu-item>
                                </sp-menu>
                            </sp-picker>
                        </sp-field-group>
                    </div>
