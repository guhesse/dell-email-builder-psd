...
export default function FpoSelector({ handleFpoValueSelected, handleFpoSegmentSelected }) {
    ...
    return (
        <>
            <sp-field-label for="fpo-value-field">Número de FPO's:</sp-field-label>
            <sp-field-group style={{ width: "100vw", display: "flex", flexDirection: "row", gap: "5px" }}>
                <sp-picker placeholder="Número de FPO's" style={{ width: "45vw", padding: "0" }} id="picker-m" size="m" label="Selection type">
                    <sp-menu>
