...
export default function NavColorSelector() {
    ...
    return (
        <>
            <div style={{ position: "absolute", right: "0px", display: "flex", flexWrap: "wrap", alignItems: "flex-end", justifyContent: "flex-end", zIndex: "9999", maxWidth: "270px" }} className="new-group" id="colors">
            
                {isOptionsOpen ? (
                    <>
                        <sp-label onClick={toggleOptions} style={{ cursor: "pointer", width: "5px", padding: "5px", backgroundColor: "rgb(38, 38, 38)", top: "0.2em" }}>
                            <div style={{ position: "absolute", right: "16px", top: "7px", display: "flex", alignItems: "flex-end"}}>
                                <span style={{ display: "flex", alignItems: "flex-end", fill: "#8a8a8a" }}>
                        ...
                        <sp-overlay style={{ position: "absolute", top: "4%", left: "1%" }}>
                        ...
                        <div style={{ paddingTop:"10px", display: "flex", flexDirection: "row", alignItems: "flex-end", justifyContent: "flex-end", margin: "0.025em 0" }}>
                            <sp-field-group style={{ padding: "5 2 8 5", }}>
                                <div style={{ display: "flex", flexDirection: "row", alignItems: "flex-end", justifyContent: "flex-end", marginBottom: "5px" }}>
                        ...
                        <div style={{ display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "flex-start", margin: "0.025em 0" }}>
                            <sp-field-group style={{ padding: "5 2 8 5", }}>
                                <div style={{ display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "flex-end", marginBottom: "5px" }}>
                    ...
                    <sp-label onClick={toggleOptions} >
                        <div style={{ position: "absolute", transform: "translate(-50%, -50%)", top: "50%", left: "50%", display: "flex", flexDirection: "row", cursor: "pointer" }}>
                            <span style={{ backgroundColor: colors["accentColor"].hex, width: "13px", height: "12px", borderRadius: "3px", marginRight: "4px" }}></span>
                            <span style={{ backgroundColor: colors["secondaryColor"].hex, width: "13px", height: "12px", borderRadius: "3px", marginRight: "4px" }}></span>
                            <span style={{ backgroundColor: colors["tertiaryColor"].hex, width: "13px", height: "12px", borderRadius: "3px", marginRight: "4px" }}></span>
                        </div>
                    </sp-label>
                )}
            </div>
