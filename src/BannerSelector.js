            ...
            <div style={{ display: "flex", flexWrap: "wrap", flexDirection: "column", alignItems: "flex-start" }} className="group">
                <sp-icons>
                    <div style={{ display: "flex", alignItems: "center" }}>
                        {((selectedBanner !== null && bannerHeadlineValue !== "" && bannerCopyValue !== "" && bannerCtaValue !== "") || selectedBanner === "") ? (
                            ...
                            (selectedBanner !== null && (bannerHeadlineValue === "" || bannerCopyValue === "" || bannerCtaValue === "")) ? (
                        ...
                        <sp-field-group style={{ width: "100vw", display: "flex", flexDirection: "row", gap: "5px" }}>
                            <sp-picker class='shortPicker' value={selectedBanner} style={{ margin: "0 4px 0 0" }} placeholder="Lado da imagem do Banner" id="picker-m" size="m" label="Selection type">
                                <sp-menu>
                                    ...
                                    <sp-menu-item selected={selectedBanner === "right" ? selected.selectedBanner : undefined} onClick={() => handleBannerClick("right")}>Right</sp-menu-item>
                                </sp-menu>
                            </sp-picker>
                                ...
                                <div style={{ display: "flex", flexWrap: "wrap", alignItems: "flex-start" }}>
                                    ...
                                    <div style={{ display: "flex", flexDirection: "column", margin: "4px 0px" }}>
                                        ...
                                        <sp-textfield
                                            ...
                                            valid={bannerCtaValue !== "" ? valid.bannerCtaValue : undefined}
                                        >
                                        </sp-textfield>
                                    </div>
                                </div>
